...
var _session_api_util2 = _interopRequireDefault(_session_api_util);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.signup = _session_api_util2.default.signup;
  window.login = _session_api_util2.default.login;
  window.logout = _session_api_util2.default.logout;
...
exports.signup = exports.logout = exports.login = exports.receiveSessionErrors = exports.receiveCurrentUser = exports.RECEIVE_SESSION_ERRORS = exports.RECEIVE_CURRENT_USER = undefined;
...
var login = exports.login = function login(user) {
  return function (dispatch) {
    return _session_api_util2.default.login(user).then(function (user) {
...
var logout = exports.logout = function logout() {
  return function (dispatch) {
    return _session_api_util2.default.logout().then(function (success) {
...
var signup = exports.signup = function signup(user) {
  return function (dispatch) {
    return _session_api_util2.default.signup(user).then(function (user) {
      return dispatch(receiveCurrentUser(user));
    }, function (err) {
      return dispatch(receiveSessionErrors(err));
    });
...
var _error_reducer = __webpack_require__(55);
